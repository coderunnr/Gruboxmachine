 ...
 */
public class StaticCartAdapter extends RecyclerView.Adapter<StaticCartAdapter.ViewHolder> {

    Context context;
    ProductListing productListing;
    List<ProductResponse> productModels;
    CartFragment cartFragment;
    LoyaltyandPayments loyaltyandPayments;
...
//            minus=(ImageView) v.findViewById(R.id.minus_quantity_cart);
    ...
    public StaticCartAdapter(LoyaltyandPayments loyaltyandPayments, List<ProductResponse> productModels, Context context, CartFragment cartFragment) {

        this.context = context;
        this.productListing=productListing;
        this.loyaltyandPayments=loyaltyandPayments;
    ...
    @Override
    public StaticCartAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
        View v;
