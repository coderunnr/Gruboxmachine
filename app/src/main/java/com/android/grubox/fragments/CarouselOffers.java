 ...
 */
public class CarouselOffers extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.fragment_carousel_left, container, false);

        carouselView = (CarouselView) v.findViewById(R.id.carouselView_offers);
